import './globals.css';
import { services, areas, testimonials, PHONE, PHONE_HREF, SMS_HREF, EMAIL, FACEBOOK_URL, INSTAGRAM_URL, FOURSQUARE_URL, BLUESKY_URL, GOOGLE_REVIEW_COUNT } from '../lib/data';
...
const jsonLd = {
  ...
  sameAs: [FACEBOOK_URL, INSTAGRAM_URL, FOURSQUARE_URL, BLUESKY_URL],
      ...
      <div className="container">
        <div className="footer-grid">
          <div>
            ...
            <a href={FOURSQUARE_URL} target="_blank" rel="noopener noreferrer" className="footer-contact-line footer-social-link" aria-label="Ottawa Garage Door Repair on Foursquare">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 110-5 2.5 2.5 0 010 5z"/></svg>
              Find us on Foursquare
            </a>
            <a href={BLUESKY_URL} target="_blank" rel="noopener noreferrer" className="footer-contact-line footer-social-link" aria-label="Ottawa Garage Door Repair on Bluesky">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M12 10.8c-2.67-4.03-7-5.8-7-5.8s-1.93 3.53-2.4 5.8C2.07 12.33 2 13 2 13.2c0 .53.27.97.67 1.2.4.23.9.23 1.3 0 .4-.23.67-.67.67-1.2 0-.2-.07-.87.6-3.2.67-2.27 2.4-5.8 2.4-5.8s4.33 1.77 7 5.8c2.67 4.03 7 5.8 7 5.8s1.93-3.53 2.4-5.8c.67-2.33.6-3 .6-3.2 0-.53-.27-.97-.67-1.2-.4-.23-.9-.23-1.3 0-.4.23-.67.67-.67 1.2 0 .2.07.87-.6 3.2-.67 2.27-2.4 5.8-2.4 5.8s-4.33-1.77-7-5.8z"/></svg>
