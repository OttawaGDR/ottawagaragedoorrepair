          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              {[
                ...
                { num: '5+', label: 'Years in Ottawa', icon: '📅' },
              ].map(stat => (
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }}>
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.75)', lineHeight: 1.9, marginBottom: 32 }}>Five years and 1,000+ Ottawa homeowners later — with a perfect 5.0 Google rating — that approach continues to work.</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                { icon: '📋', title: 'Licensed and Fully Insured', desc: 'Fully licensed in Ontario with $2 million liability coverage on every job.' },
