...
const CONTENT = {
  ...
  nepean: entry({
    ...
    localContextExtra: `Commercial and light-industrial bays near Merivale and Colonnade get the same crew standards as residential: security, uptime, and written quotes before repair. For homeowners near Bells Corners and Centrepointe, we’re used to sloped driveways toward the Greenbelt and seals that fail after ice buildup.`,
    neighborhoods: [
      'Bells Corners',
      'Centrepointe',
      'Merivale corridor',
    ...
    highlights: [
      ...
      { icon: '🏢', title: 'Light commercial', desc: 'Sectional and rolling doors on Merivale-area plazas and small bays serviced same-day when possible.' },
  ...
  gloucester: entry({
    ...
    localContext: `East-end routing keeps Gloucester jobs off the back of cross-town traffic. We service townhomes with party-wall garages, detached singles near Orleans borders, and light commercial sectional doors in plaza bays along Ogilvie and Montreal Road corridors.`,
    ...
    doorProfile:
      'Gloucester housing includes 1970s–90s bungalows, townhome garages with standard 8x7 or 9x7 doors, and newer insulated doubles on infill streets. Townhomes often need belt-drive openers for noise; older singles may still run single springs that should be paired. Light commercial sectional doors appear in mixed-use plazas.',
    installNote:
    ...
    highlights: [
      ...
      { icon: '🏢', title: 'Light commercial', desc: 'Plaza and small bay sectional doors serviced with residential-grade accountability.' },
    ],
    areaFaqs: [
      {
