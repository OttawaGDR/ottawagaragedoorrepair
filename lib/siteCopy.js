...
export const whyChooseUsCards = [
  { icon: '🚚', title: 'Stocked Mobile Workshop', desc: `Springs, cables, rollers, and opener parts travel with us — ${FIRST_VISIT_STAT} jobs done without a second appointment.` },
  ...
  { icon: 'star', title: 'Verified Local Reviews', desc: 'Real 5-star feedback from Kanata, Barrhaven, Orleans, and Nepean — not outsourced call-centre crews.' },
...
export const testimonialsSection = {
  label: 'Reviews',
  title: 'What Ottawa Clients Say',
  ratingNote: '5.0 average from reviews',
};
