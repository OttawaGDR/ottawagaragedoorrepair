...
export const faqCategories = [
  ...
  },
  {
    ...
    shortLabel: 'Service',
    questions: [
      { id: 'b1', q: 'How do I book garage door service with Ottawa - GDR?', a: 'Call (613) 617-4238 anytime, use our online booking page, or request a callback through the contact form. We confirm timing and a price range before dispatch.' },
